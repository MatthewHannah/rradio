...
const RDS_DECIMATE: usize = 25;

/// RDS matched filter taps: RRC with α=1 at 2375 Hz chip rate.
/// Generated by py/rds_matched_filter.py --fs 9600 --spans 8 --window blackman
const RDS_MATCHED_FILTER_TAPS: [f32; 65] = [
    7.6271953e-21,  2.8595134e-07,  2.2403845e-06, -2.8417953e-06,
   -1.0878511e-05,  8.9545607e-06,  3.0557567e-05, -2.0319755e-05,
   -6.9313360e-05,  3.9403747e-05,  1.4039439e-04, -6.9521307e-05,
   -2.6515737e-04,  1.1493711e-04,  4.7807447e-04, -1.8108019e-04,
   -8.3617889e-04,  2.7505302e-04,  1.4385431e-03, -4.0682902e-04,
   -2.4705763e-03,  5.9209413e-04,  4.3175291e-03, -8.5944093e-04,
   -7.9057826e-03,  1.2713316e-03,  1.6001920e-02, -2.0032266e-03,
   -4.0589138e-02,  3.8526392e-03,  2.1440267e-01,  4.9992764e-01,
    6.3574856e-01,  4.9992764e-01,  2.1440267e-01,  3.8526392e-03,
   -4.0589138e-02, -2.0032266e-03,  1.6001920e-02,  1.2713316e-03,
   -7.9057826e-03, -8.5944093e-04,  4.3175291e-03,  5.9209413e-04,
   -2.4705763e-03, -4.0682902e-04,  1.4385431e-03,  2.7505302e-04,
   -8.3617889e-04, -1.8108019e-04,  4.7807447e-04,  1.1493711e-04,
   -2.6515737e-04, -6.9521307e-05,  1.4039439e-04,  3.9403747e-05,
   -6.9313360e-05, -2.0319755e-05,  3.0557567e-05,  8.9545607e-06,
   -1.0878511e-05, -2.8417953e-06,  2.2403845e-06,  2.8595134e-07,
    7.6271953e-21,
];
...
fn run(iq_source: IqSource, audio_output: AudioOutput, done_sig: Arc<atomic::AtomicBool>, obs_settings: AudioPipelineObservationSettings) {
    ...
    eprintln!("  RDS:   wfm @ {} Hz → ÷{} → {} Hz baseband",
        wfm_fs, RDS_DECIMATE, wfm_fs / RDS_DECIMATE as f32);
